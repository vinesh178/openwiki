...
import { ANTHROPIC_API_KEY_ENV_KEY, BASETEN_API_KEY_ENV_KEY, FIREWORKS_API_KEY_ENV_KEY, getDefaultModelId, getProviderApiKeyEnvKey, getProviderLabel, getProviderModelOptions, isValidModelId, normalizeModelId, normalizeProvider, OPENAI_API_KEY_ENV_KEY, OPENWIKI_PROVIDER_ENV_KEY, OPENWIKI_MODEL_ID_ENV_KEY, OPENROUTER_API_KEY_ENV_KEY, OPEN_WIKI_DIR, resolveConfiguredProvider, SELECTABLE_OPENWIKI_PROVIDERS, OPENWIKI_VERSION, } from "./constants.js";
...
function ChatInput({ currentModelId, currentProvider, onClear, onCommandRun, onModelSelect, onProviderSelect, onSubmit, }) {
    ...
    async function saveProviderSelection(rawProvider) {
        ...
        try {
            ...
            resetInput();
            setNotice(`Provider switched to ${getProviderLabel(provider)} with model ${getDefaultModelId(provider)}. Ensure ${getProviderApiKeyEnvKey(provider)} is set.`);
        }
        catch (saveError) {
            setError(saveError instanceof Error
                ? saveError.message
