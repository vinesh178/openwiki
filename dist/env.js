...
import { ANTHROPIC_API_KEY_ENV_KEY, BASETEN_API_KEY_ENV_KEY, FIREWORKS_API_KEY_ENV_KEY, isValidModelId, normalizeProvider, OLLAMA_API_KEY_ENV_KEY, OPENAI_API_KEY_ENV_KEY, OPENROUTER_API_KEY_ENV_KEY, OPENWIKI_MODEL_ID_ENV_KEY, OPENWIKI_PROVIDER_ENV_KEY, } from "./constants.js";
...
function createCredentialDiagnostic(key, fileEnv) {
    ...
    return {
        ...
        source,
        length: value.length,
        preview: key === OPENWIKI_MODEL_ID_ENV_KEY || key === OPENWIKI_PROVIDER_ENV_KEY
